...
const features = [
  {
    icon: Zap,
    title: "Hızlı Kurulum",
    description: "SaaS ürünlerinizi dakikalar içinde aktif edin, hemen kullanmaya başlayın.",
  },
  {
    icon: Shield,
    title: "Güvenli Altyapı",
    description: "256-bit SSL, PayTR entegrasyonu ve çok kiracılı izolasyon ile verileriniz güvende.",
  },
  {
    icon: Globe,
    title: "Ajans + SaaS",
    description: "Yazılım paketlerinden kurumsal hizmetlere — tek platformda tüm dijital ihtiyaçlarınız.",
  },
];
      ...
      <section className="relative mx-auto max-w-7xl px-4 py-28 sm:px-6 lg:py-36">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-400 leading-relaxed">
            Nexa; SaaS yazılımları, ajans hizmetleri ve kurumsal çözümleri tek çatı
            altında sunan modern bir dijital platformdur. Ölçeklenebilir, güvenli ve
            kullanıma hazır.
          </p>
